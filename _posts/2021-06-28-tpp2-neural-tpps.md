...
You can find the dataset and a [Jupyter notebook](https://colab.research.google.com/github/shchur/shchur.github.io/blob/master/assets/notebooks/tpp2/neural_tpp.ipynb) with all the code used in this blog post [here](https://github.com/shchur/shchur.github.io/blob/master/assets/notebooks/tpp2/).
...
Here is a link to the [Jupyter notebook](https://colab.research.google.com/github/shchur/shchur.github.io/blob/master/assets/notebooks/tpp2/neural_tpp.ipynb) with all the code we've seen so far, but where the different model components are nicely wrapped into a single <tt>nn.Module</tt>.
...
See the [Jupyter notebook](https://colab.research.google.com/github/shchur/shchur.github.io/blob/master/assets/notebooks/tpp2/neural_tpp.ipynb) for details.
